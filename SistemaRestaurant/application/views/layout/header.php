...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<?php
		//para validar que el usuario a iniciado session y no acceda por medio de url
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Gerente</b></span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url();?>clogin" class="btn btn-default btn-flat">Salir</a>
                </div>
              </li>
            </ul>
          </li>
